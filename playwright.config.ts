...
/**
 * Configuration object for ReportPortal integration.
 */
...
export default defineConfig({
  ...
  reporter: [
    [`./utils/report/summaryReport.ts`], // if any test case failed it sends a MS TEAM notification.
    ['list'],
    ['html', { open: 'never', outputFolder: './.tmp/report' }],
    ['@reportportal/agent-js-playwright', RPconfig], // Report Portal reporting
  ],
